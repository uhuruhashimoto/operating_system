...
K_SRCS = kernel_start.c data_structures/pcb.c data_structures/queue.c data_structures/frame_table.c trap_handlers/trap_handlers.c syscalls/process_syscalls.c process_management/load_program.c
K_INCS = $(K_SRCS:%.c=%.o) 
